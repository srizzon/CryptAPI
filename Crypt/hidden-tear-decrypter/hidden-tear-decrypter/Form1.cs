...
namespace hidden_tear_decrypter
{
    public partial class Form1 : Form
    {
        ...
        string userDir = "C:\\Users\\" + Environment.UserName + "\\Desktop\\Faculdade\\";
        ...
        public byte[] AES_Decrypt(byte[] bytesToBeDecrypted, byte[] passwordBytes)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                using (RijndaelManaged AES = new RijndaelManaged())
                {
                    ...
                    {
                        throw new Exception("Chave de descriptografia inválida");
                    }
        ...
        public void DecryptDirectory(string location)
        {
            ...
            try
            {
                ...
                label3.Text = "Arquivos descriptografados!";
                label3.ForeColor = Color.Green;
            }
            catch (Exception)
            {
                label3.Text = "Erro ao descriptografar!";
